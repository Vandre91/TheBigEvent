...
namespace TheBigEvent.Services
{
    public class EventService
    {
        ...
        public void addEvent(string _NomEvent, string _Localisation, int _MenuId, int _SalleId, int _TraiteurId, int _DecoId, int _UserId, int NbInvite, int Prix)
        {
            _eLink.AddEvent( _NomEvent, _Localisation, _MenuId, _SalleId, _TraiteurId,_DecoId,_UserId, NbInvite, Prix);
        }
