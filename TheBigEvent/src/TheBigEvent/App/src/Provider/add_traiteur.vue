...
<br>Les menus sont catégoriser par Entré | Plat | Dessert et leurs prix diffèrent par rapport au nombre de personne.
<br>Exemple : Un gateau pour 8 personnes coûtent 10€.
</h4>
        <div id="1" class="on">
        ...
        <div id="2" class="off">
            <div @submit="onSubmit2($event)" class=".col-lg-12 forms">
                <form role="form">
                    ...
                    <div class="form-group">
                        <label>*Prix approximatif (en €) par rapport au nombre de personnes:  </label>
